...
const sections: HousingSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '社宅二房東大稽查：2026/5 起內政部聯合各縣市政府啟動全國社宅稽查專案，查緝私下轉租、冒名申請、人頭戶等違規行為。違者立即終止租約並移送法辦，列入社宅終身停權黑名單，不得再申請任何政府住宅補助', highlight: true },
    ],
  },
  {
    icon: TrendingUp,
    title: '科技投資對租屋市場影響',
    subtitle: '2026-05-22 更新｜AMD CEO 蘇姿丰演講：AI 才打到第三局／CPU 年增 35%／AI 推論崛起',
    items: [
